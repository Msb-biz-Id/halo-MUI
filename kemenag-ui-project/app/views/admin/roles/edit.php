    ...
    <div class="col-lg-10">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-warning">
                <h5 class="mb-0 text-dark"><i class="uil-edit"></i> Edit Role: <?= htmlspecialchars($role['name']) ?></h5>
            </div>
            ...
            <div class="card-body">
                <form action="<?= url('/admin/roles/edit/' . $role['id']) ?>" method="POST">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="name" name="name" 
                                   value="<?= htmlspecialchars($role['name']) ?>" readonly>
                            <small class="text-muted">System role, tidak bisa diubah</small>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="alert alert-info">
                        <strong>Info:</strong> Users dengan role ini: <strong><?= $role['user_count'] ?? 0 ?></strong> orang
                    </div>
                    
                    <hr class="my-4">
                    
                    <h6 class="fw-bold mb-3">Edit Permissions:</h6>
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-primary btn-lg px-5">
                            <i class="uil-check"></i> Update Permissions
                        </button>
